...
class Profile(TimeStampedUUIDModel):
    ...
    gender = models.CharField(verbose_name=_("Gennder"),choices=Gender.choices, default=Gender.OTHER, max_length=20)
    country = CountryField(verbose_name=_("Country"), default="AU", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Sydney", blank=False, null=False)
