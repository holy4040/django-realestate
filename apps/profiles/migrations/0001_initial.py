# Generated by Django 3.2.7 on 2022-06-03 13:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Other', max_length=20, verbose_name='Gennder')),
                ('country', django_countries.fields.CountryField(default='AU', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Sydney', max_length=180, verbose_name='City')),
